...
func (*PotInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*CardInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (*PlayerInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
var fileDescriptor0 = []byte{
	...
	,
}
