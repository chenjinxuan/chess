...
It has these top-level messages:
	...
	RoomTableChatAck
	RoomTableChatReq
	RoomPlayerAutoSitdownAck
	RoomPlayerAutoSitdownReq
	RoomPlayerAwardReq
	RoomPlayerAwardAck
	PotInfo
	TableInfo
...
func (m *RoomPlayerStandupAck) GetForce() bool {
	if m != nil {
		return m.Force
	}
	return false
...
// 2120, 牌桌聊天消息回复
type RoomTableChatAck struct {
	Id     string `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
	Body   []byte `protobuf:"bytes,2,opt,name=body,proto3" json:"body,omitempty"`
	Offset int64  `protobuf:"varint,3,opt,name=offset" json:"offset,omitempty"`
}

func (m *RoomTableChatAck) Reset()                    { *m = RoomTableChatAck{} }
func (m *RoomTableChatAck) String() string            { return proto1.CompactTextString(m) }
func (*RoomTableChatAck) ProtoMessage()               {}
func (*RoomTableChatAck) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }

func (m *RoomTableChatAck) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *RoomTableChatAck) GetBody() []byte {
	if m != nil {
		return m.Body
	}
	return nil
...
func (m *RoomTableChatAck) GetOffset() int64 {
	if m != nil {
		return m.Offset
	}
	return 0
...
// 2121, 牌桌发送聊天消息
type RoomTableChatReq struct {
	BaseReq *BaseReq `protobuf:"bytes,1,opt,name=base_req,json=baseReq" json:"base_req,omitempty"`
	Id      string   `protobuf:"bytes,2,opt,name=id" json:"id,omitempty"`
	Body    []byte   `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`
}

func (m *RoomTableChatReq) Reset()                    { *m = RoomTableChatReq{} }
func (m *RoomTableChatReq) String() string            { return proto1.CompactTextString(m) }
func (*RoomTableChatReq) ProtoMessage()               {}
func (*RoomTableChatReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }

func (m *RoomTableChatReq) GetBaseReq() *BaseReq {
	if m != nil {
		return m.BaseReq
	}
	return nil
...
func (m *RoomTableChatReq) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *RoomTableChatReq) GetBody() []byte {
	if m != nil {
		return m.Body
	}
	return nil
...
// 2122, 自动坐下等待玩家数通报
type RoomPlayerAutoSitdownAck struct {
	Num   int32   `protobuf:"varint,1,opt,name=num" json:"num,omitempty"`
	Queue []int32 `protobuf:"varint,2,rep,packed,name=queue" json:"queue,omitempty"`
}

func (m *RoomPlayerAutoSitdownAck) Reset()                    { *m = RoomPlayerAutoSitdownAck{} }
func (m *RoomPlayerAutoSitdownAck) String() string            { return proto1.CompactTextString(m) }
func (*RoomPlayerAutoSitdownAck) ProtoMessage()               {}
func (*RoomPlayerAutoSitdownAck) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }

func (m *RoomPlayerAutoSitdownAck) GetNum() int32 {
	if m != nil {
		return m.Num
	}
	return 0
...
func (m *RoomPlayerAutoSitdownAck) GetQueue() []int32 {
	if m != nil {
		return m.Queue
	}
	return nil
...
// 2123, 玩家加入自动坐下队列
type RoomPlayerAutoSitdownReq struct {
	BaseReq *BaseReq `protobuf:"bytes,1,opt,name=base_req,json=baseReq" json:"base_req,omitempty"`
}

func (m *RoomPlayerAutoSitdownReq) Reset()                    { *m = RoomPlayerAutoSitdownReq{} }
func (m *RoomPlayerAutoSitdownReq) String() string            { return proto1.CompactTextString(m) }
func (*RoomPlayerAutoSitdownReq) ProtoMessage()               {}
func (*RoomPlayerAutoSitdownReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }

func (m *RoomPlayerAutoSitdownReq) GetBaseReq() *BaseReq {
	if m != nil {
		return m.BaseReq
	}
	return nil
...
// 2124, 玩家打赏荷官
type RoomPlayerAwardReq struct {
	BaseReq *BaseReq `protobuf:"bytes,1,opt,name=base_req,json=baseReq" json:"base_req,omitempty"`
}

func (m *RoomPlayerAwardReq) Reset()                    { *m = RoomPlayerAwardReq{} }
func (m *RoomPlayerAwardReq) String() string            { return proto1.CompactTextString(m) }
func (*RoomPlayerAwardReq) ProtoMessage()               {}
func (*RoomPlayerAwardReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{36} }

func (m *RoomPlayerAwardReq) GetBaseReq() *BaseReq {
	if m != nil {
		return m.BaseReq
	}
	return nil
...
// 2125, 玩家打赏荷官回复
type RoomPlayerAwardAck struct {
	BaseAck  *BaseAck `protobuf:"bytes,1,opt,name=base_ack,json=baseAck" json:"base_ack,omitempty"`
	PlayerId int32    `protobuf:"varint,2,opt,name=player_id,json=playerId" json:"player_id,omitempty"`
	Chips    int32    `protobuf:"varint,3,opt,name=chips" json:"chips,omitempty"`
}

func (m *RoomPlayerAwardAck) Reset()                    { *m = RoomPlayerAwardAck{} }
func (m *RoomPlayerAwardAck) String() string            { return proto1.CompactTextString(m) }
func (*RoomPlayerAwardAck) ProtoMessage()               {}
func (*RoomPlayerAwardAck) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{37} }

func (m *RoomPlayerAwardAck) GetBaseAck() *BaseAck {
	if m != nil {
		return m.BaseAck
	}
	return nil
...
func (m *RoomPlayerAwardAck) GetPlayerId() int32 {
	if m != nil {
		return m.PlayerId
	}
	return 0
...
func (m *RoomPlayerAwardAck) GetChips() int32 {
	if m != nil {
		return m.Chips
	}
	return 0
...
func (*PotInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func (*TableInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func (*CardInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{40} }
...
func (*PlayerInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41} }
...
func init() {
	...
	proto1.RegisterType((*RoomTableChatAck)(nil), "proto.RoomTableChatAck")
	proto1.RegisterType((*RoomTableChatReq)(nil), "proto.RoomTableChatReq")
	proto1.RegisterType((*RoomPlayerAutoSitdownAck)(nil), "proto.RoomPlayerAutoSitdownAck")
	proto1.RegisterType((*RoomPlayerAutoSitdownReq)(nil), "proto.RoomPlayerAutoSitdownReq")
	proto1.RegisterType((*RoomPlayerAwardReq)(nil), "proto.RoomPlayerAwardReq")
	proto1.RegisterType((*RoomPlayerAwardAck)(nil), "proto.RoomPlayerAwardAck")
...
var fileDescriptor0 = []byte{
	...
	,
}
