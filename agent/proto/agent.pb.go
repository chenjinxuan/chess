...
func (*PotInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }
...
func (*TableInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func (*CardInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
func (*PlayerInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
var fileDescriptor0 = []byte{
	...
	,
}
